...
class Carrinho{
    #itens
    // #itens = []  // dispensa o uso do construtor
    ...
    removerItem(nome) {
        const indice = this.#obterIndice(nome.toLowerCase())
        if (indice>= 0){
    ...
    #obterIndice(nome){
        return this.#itens.indexOf(nome.toLowerCase()) // retorna o indice do item, com o nome "nome"
    }
...
carrinho.adicionarItem("Blusa")

console.log(carrinho.itens)
console.log(carrinho.itens.pop())
console.log(carrinho.itens)

carrinho.adicionarItem("TENNIS")
console.log(carrinho.itens)
